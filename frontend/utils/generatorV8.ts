...
function setPixel(png: PNG, x: number, y: number, color: number[]) {
...
function drawRect(png: PNG, x_off: number, y_off: number, x: number, y: number, w: number, h: number, color: number[]) {
...
function drawCircle(png: PNG, x_off: number, y_off: number, cx: number, cy: number, r: number, color: number[]) {
...
function drawHumanoid(png: PNG, x_off: number, y_off: number, frame: number, theme: any, anim: string) {
    let bob = 0;
...
function drawSnake(png: PNG, x_off: number, y_off: number, frame: number, theme: any, anim: string) {
...
function drawBeast(png: PNG, x_off: number, y_off: number, frame: number, theme: any, anim: string) {
...
function drawAlien(png: PNG, x_off: number, y_off: number, frame: number, theme: any, anim: string) {
...
export function generateMonsterSprite(id: number): Buffer {
    ...
    for (let row = 0; row < 4; row++) {
        for (let col = 0; col < 4; col++) {
            ...
            if (archetype === 'HUMANOID') drawHumanoid(png, x_off, y_off, frame, theme, 'GOLEM'); // Fixed signature
